        ...
        <div className="relative bg-gradient-to-tr from-blue-600 to-purple-500 rounded py-10 px-8 md:py-16 md:px-12 overflow-hidden" data-aos="zoom-out">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
              <h3 className="text-4xl font-bold font-uncut-sans mb-2">Get started with Cadra</h3>
              <p className="text-blue-200">It only takes a few minutes to get started with Cadra. Understand your users, start free, today.</p>
            </div>
            {/* CTA button */}
