      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-uncut-sans mb-4">Utilize our expert support and resources</h2>
            <div className="max-w-2xl mx-auto">
              <p className="text-xl text-gray-400">Our dedicated support team and extensive library of resources will guide you every step of the way. From onboarding to ongoing maintenance, TurboInfra is here to help you navigate your infrastructure transformation with confidence.</p>
            </div>
          </div>
          {/* Section content */}
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-center md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
            ...
            <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none" data-aos="zoom-out" data-aos-delay="200">
              <div className="text-center md:text-left">
                <h3 className="h3 font-uncut-sans text-4xl mb-4">Standardized Infrastructure-as-Code</h3>
                <p className="text-xl text-gray-400 mb-6">Manage and provision infrastructure resources like a pro by automating infrastructure management and leveraging version control.</p>
