      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-uncut-sans">Resources to help you get the most out of Cadra</h2>
          </div>
          {/* Content */}
          <div>
            {/* Category buttons */}
            ...
            <div className="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-2 md:grid-cols-4 sm:gap-x-6 sm:gap-y-8 items-start">
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Cadra Telegram</div>
              </a>
              {/* 2nd Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Cadra Discord</div>
              </a>
              {/* 3rd Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Cadra Medium</div>
              </a>
              {/* 4th Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Cadra GitHub</div>
              </a>
              {/* 5th Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Cadra Docs</div>
              </a>
              {/* 6th Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Cadra Tutorials</div>
              </a>
            </div>
          </div>
        </div>
