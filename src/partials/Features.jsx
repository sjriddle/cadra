      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="text-center pb-12 md:pb-20">
            <h2 className="h2 font-uncut-sans" data-aos="zoom-out">Developer-friendly platform</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="flex flex-col items-center" data-aos="zoom-out">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">Streamlined Workflows</h4>
              <p className="text-lg text-gray-400 text-center">Our integrated toolchain simplifies and automates your processes, enabling seamless collaboration between developers, QA, and operations teams.</p>
            </div>
            {/* 2nd item */}
            <div className="flex flex-col items-center" data-aos="zoom-out" data-aos-delay="200">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">AI-Driven Automation & Scaling</h4>
              <p className="text-lg text-gray-400 text-center">Cadra uses AI to optimize resource allocation, manage robust automation, and enable seamless scaling.</p>
            </div>
            {/* 3rd item */}
            <div className="flex flex-col items-center" data-aos="zoom-out" data-aos-delay="400">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">Unparalleled Security</h4>
              <p className="text-lg text-gray-400 text-center">Protect your infrastructure, compliance, and data with our vulnerability scanning, automated security testing, and access control features.</p>
            </div>
          </div>
        </div>
      </div>
